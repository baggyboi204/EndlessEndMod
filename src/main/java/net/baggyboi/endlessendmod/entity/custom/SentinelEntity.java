...
public class SentinelEntity extends FlyingMob implements Enemy {
    ...
    public static boolean checkSentinelSpawnRules(EntityType<SentinelEntity> pSentinel, LevelAccessor pLevel, MobSpawnType pSpawnType, BlockPos pPos, RandomSource pRandom) {
        return pLevel.getDifficulty() != Difficulty.PEACEFUL && pRandom.nextInt(20) == 0 && checkMobSpawnRules(pSentinel, pLevel, pSpawnType, pPos, pRandom);
    }
